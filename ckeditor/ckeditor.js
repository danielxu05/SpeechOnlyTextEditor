...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "K4J9", version: "4.14.0", revision: "8a12b04171", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
...
*/
    ...
    }); var langs = [["Afrikaans", ["af-ZA"]], ["Bahasa Indonesia", ["id-ID"]], ["Bahasa Melayu", ["ms-MY"]], ["Català", ["ca-ES"]], ["Čeština", ["cs-CZ"]], ["Deutsch", ["de-DE"]], ["English", ["en-AU", "Australia"], ["en-CA", "Canada"], ["en-IN", "India"], ["en-NZ", "New Zealand"], ["en-ZA", "South Africa"], ["en-GB", "United Kingdom"], ["en-US", "United States"]], ["Español", ["es-AR", "Argentina"], ["es-BO", "Bolivia"], ["es-CL", "Chile"], ["es-CO", "Colombia"], ["es-CR", "Costa Rica"], ["es-EC", "Ecuador"], ["es-SV", "El Salvador"], ["es-ES", "España"],
        ["es-US", "Estados Unidos"], ["es-GT", "Guatemala"], ["es-HN", "Honduras"], ["es-MX", "México"], ["es-NI", "Nicaragua"], ["es-PA", "Panamá"], ["es-PY", "Paraguay"], ["es-PE", "Perú"], ["es-PR", "Puerto Rico"], ["es-DO", "República Dominicana"], ["es-UY", "Uruguay"], ["es-VE", "Venezuela"]], ["Euskara", ["eu-ES"]], ["Français", ["fr-FR"]], ["Galego", ["gl-ES"]], ["Hrvatski", ["hr_HR"]], ["IsiZulu", ["zu-ZA"]], ["Íslenska", ["is-IS"]], ["Italiano", ["it-IT", "Italia"], ["it-CH", "Svizzera"]], ["Magyar", ["hu-HU"]], ["Nederlands", ["nl-NL"]],
    ["Norsk bokmål", ["nb-NO"]], ["Polski", ["pl-PL"]], ["Português", ["pt-BR", "Brasil"], ["pt-PT", "Portugal"]], ["Română", ["ro-RO"]], ["Slovenčina", ["sk-SK"]], ["Suomi", ["fi-FI"]], ["Svenska", ["sv-SE"]], ["Türkçe", ["tr-TR"]], ["български", ["bg-BG"]], ["Pусский", ["ru-RU"]], ["Српски", ["sr-RS"]], ["한국어", ["ko-KR"]], ["中文", ["cmn-Hans-CN", "普通话 (中国大陆)"], ["cmn-Hans-HK", "普通话 (香港)"], ["cmn-Hant-TW", "中文 (台灣)"], ["yue-Hant-HK", "粵語 (香港)"]], ["日本語", ["ja-JP"]], ["Lingua latīna", ["la"]]], CKWebSpeechCommandVoice = function (a) {
    this._editor =
        a; this._regexpcommand = this._commands = this._commandvoice = !1; this.CKWebSpeechCommandVoice(this._editor.config)
    }; CKWebSpeechCommandVoice.prototype.CKWebSpeechCommandVoice = function () { "undefined" == typeof this._editor.config.ckwebspeech && (this._editor.config.ckwebspeech = {}); this.setCommands(this._editor.config) };
    CKWebSpeechCommandVoice.prototype.setCommands = function (a) { var b = !1, c = !1; a.ckwebspeech.commandvoice && (b = a.ckwebspeech.commandvoice); a.ckwebspeech.commands && (c = this.makeCommands(a.ckwebspeech.commands)); b && c && (this._regexpcommand = RegExp("(" + b + "){1}\\s{1}(" + c + ")", "gi"), this._commands = a.ckwebspeech.commands, this._commandvoice = b) };
    CKWebSpeechCommandVoice.prototype.makeCommands = function (a) { var b = ""; if (a instanceof Array) { for (var c = 0; c < a.length; c++)b += this.makeValidCommand(a[c]); return "" == b ? !1 : b.replace(/\|$/gi, "") } return !1 }; CKWebSpeechCommandVoice.prototype.makeValidCommand = function (a) { var b = /(newline|newparagraph|undo|redo)/; if ("object" == typeof a) for (var c in a) if (b.test(c)) return a[c] + "|"; return "" };
    CKWebSpeechCommandVoice.prototype.buildResult = function (a) { if (this._regexpcommand) { for (var b, c = []; null != (b = this._regexpcommand.exec(a));)c.push(b[2]); for (b = 0; b < c.length; b++)var d = new String(c[b]), a = this.execCmd(this.getCommandForResult(d), d, a) } return a };
    CKWebSpeechCommandVoice.prototype.execCmd = function (a, b, c) { b = RegExp(this._commandvoice + " " + b + "\\s?", "gi"); switch (a) { case "newline": return c.replace(b, "\n"); case "newparagraph": return c.replace(b, "\n\n"); case "undo": return this._editor.execCommand("undo"), !1; case "redo": return this._editor.execCommand("redo"), !1; default: return c } };
    CKWebSpeechCommandVoice.prototype.getCommandForResult = function (a) { this._commands; for (var b = 0; b < this._commands.length; b++)for (var c in this._commands[b]) if (this._commands[b][c] == a) return c; return "" }; var CKWebSpeechHandler = function (a) { CKWebSpeechCommandVoice.call(this, a); this._currentCulture = { val: "en-US", langVal: 6 }; this._elmtPlugIcon; this._plugPath; this._recognizing; this._recognition; this._ignoreOnend; this._start_timestamp; this._working; this.CKWebSpeechHandler() }; CKWebSpeechHandler.prototype = Object.create(CKWebSpeechCommandVoice.prototype);
    CKWebSpeechHandler.prototype.CKWebSpeechHandler = function () { this._recognition; this._plugPath = this._editor.plugins.ckwebspeech.path; this._working = this._ignoreOnend = this._recognizing = !1; this.getElementPluginIcon(); this.initServiceSpeech() }; CKWebSpeechHandler.prototype.isUnlockedService = function () { return !("webkitSpeechRecognition" in window) ? !1 : !0 };
    CKWebSpeechHandler.prototype.getElementPluginIcon = function () { var a = this, b = 0, c = setInterval(function () { b++; var d; try { d = document.getElementById(a._editor.ui.instances.webSpeechEnabled._.id) } catch (e) { d = null } null !== d && (a._elmtPlugIcon = d.getElementsByClassName("cke_button__webspeechenabled_icon")[0], clearInterval(c)); 500 == b && clearInterval(c) }, 1) };
    CKWebSpeechHandler.prototype.updateIcons = function () {
        this._recognizing ? (this._editor.ui.get("webSpeechEnabled").label = "Disable", this._editor.ui.get("webSpeechEnabled").icon = this._plugPath + "icons/webspeech.png", this._elmtPlugIcon.style.backgroundImage = "url(" + this._plugPath + "icons/webspeech-enable.gif)") : (this._editor.ui.get("webSpeechEnabled").label = "Enable", this._editor.ui.get("webSpeechEnabled").icon = this._plugPath + "icons/webspeech-enable.gif", this._elmtPlugIcon.style.backgroundImage = "url(" + this._plugPath +
            "icons/webspeech.png)")
    };
    CKWebSpeechHandler.prototype.initServiceSpeech = function () { if (this.isUnlockedService()) { this._recognition = new webkitSpeechRecognition; this._recognition.continuous = !0; this._recognition.interimResults = !0; var a = this; this._recognition.onstart = function () { a.onStart() }; this._recognition.onerror = function (b) { a.onError(b) }; this._recognition.onend = function () { a.onEnd() }; this._recognition.onresult = function (b) { a.onResult(b) }; this._recognition.onspeechstart = function () { a.onSpeech() }; this._recognition.onspeechend = function () { a.onSpeechEnd() } } };
    CKWebSpeechHandler.prototype.onStart = function () { this._recognizing = !0; this.updateIcons() }; CKWebSpeechHandler.prototype.onError = function (a) { "no-speech" == a.error && (this._ignore_onend = !0); "audio-capture" == a.error && (this._ignore_onend = !0); "not-allowed" == a.error && (this._ignore_onend = !0); this.updateIcons() }; CKWebSpeechHandler.prototype.onEnd = function () { this._recognizing = !1; this._ignoreOnend || this.updateIcons() };
    CKWebSpeechHandler.prototype.onSpeech = function () { this._elmtPlugIcon.style.backgroundImage = "url(" + this._plugPath + "icons/speech.gif)" }; CKWebSpeechHandler.prototype.onSpeechEnd = function () { this.updateIcons() };
    CKWebSpeechHandler.prototype.onResult = function (a) { if ("undefined" == typeof a.results) this._recognizing = !1, this._recognition.onend = null, this._recognition.stop(), this.updateIcons(); else { this._elmtPlugIcon.style.backgroundImage = "url(" + this._plugPath + "icons/speech.gif)"; for (var b = a.resultIndex; b < a.results.length; ++b)if (a.results[b].isFinal) { var c = this.buildResult(a.results[b][0].transcript); c && this._editor.insertText(c); this.updateIcons() } } };
    CKWebSpeechHandler.prototype.toogleSpeech = function () { this._recognizing ? this._recognition.stop() : (this._recognition.lang = this._currentCulture.val, this._recognition.start(), this._ignore_onend = !1, this._start_timestamp = (new Date).getTime()) }; var CKWebSpeech = function (a) { CKWebSpeechHandler.call(this, a); this._langs = langs; this.CKWebSpeech() }; CKWebSpeech.prototype = Object.create(CKWebSpeechHandler.prototype);
    CKWebSpeech.prototype.CKWebSpeech = function () { "undefined" == typeof this._editor.config.ckwebspeech && (this._editor.config.ckwebspeech = {}); this._editor.config.ckwebspeech.culture && this.setDialectByCulture(this._editor.config.ckwebspeech.culture) }; CKWebSpeech.prototype.setDialectByCulture = function (a) { for (var b = 0; b < this._langs.length; b++)for (var c = 1; c < this._langs[b].length; c++)if (this._langs[b][c][0].toLowerCase() == a.toLowerCase()) return this._currentCulture = { val: this._langs[b][c][0], langVal: b }; return this._currentCulture };
    CKWebSpeech.prototype.setDialectByLanguage = function (a) { this.setDialectByCulture(this._langs[a][1][0]) }; CKWebSpeech.prototype.getLanguages = function () { for (var a = [], b = 0; b < this._langs.length; b++)a.push([this._langs[b][0], b]); return a }; CKWebSpeech.prototype.getCultures = function (a) { "undefined" === typeof a && (a = this._currentCulture.langVal); for (var b = [], c = 1; c < this._langs[a].length; c++)b.push(Array(this._langs[a][c][0])); return b };
    CKEDITOR.plugins.add("ckwebspeech", {
        icons: "webspeech", init: function (a) {
        a.ckWebSpeech = new CKWebSpeech(a); var b = this.path; a.addCommand("webspeechDialog", new CKEDITOR.dialogCommand("webspeechDialog")); a.addCommand("webspeechToogle", { exec: function (a) { a.ckWebSpeech.toogleSpeech() } }); a.ui.addButton("webSpeechEnabled", { label: "Enable", icon: b + "icons/webspeech.png", command: "webspeechToogle", toolbar: "ckwebspeech" }); a.ui.addButton("webSpeechSettings", {
            label: "Settings", icon: b + "icons/webspeech-settings.png", command: "webspeechDialog",
            toolbar: "ckwebspeech"
        }); CKEDITOR.dialog.add("webspeechDialog", this.path + "dialogs/ckwebspeech.js")
        }
    }); CKEDITOR.plugins.add("Text2Speech", { init: function (a) { a.addCommand("t2s", { exec: Text2Speech }); a.ui.addButton("t2s_button", { label: "Leggimi", icon: this.path + "icons/icona-audio.png", command: "t2s" }) } }); function Text2Speech() { var a = ""; my_instance(); a = my_instance().document.getBody().getText(); "" < a && winopen("https://translate.google.com/translate_tts?tl=it&q=" + a, 100, 100) }
    function winopen(a, b, c) { sleep(50); winunder = window.open(a, "height=" + c + ",width=" + b + ",menubar=no,location=no,status=no,toolbar=no,top=10,left=10") } function my_instance() { for (var a in CKEDITOR.instances) if (CKEDITOR.instances[a].focusManager.hasFocus) return CKEDITOR.instances[a] } function selected_text(a) { return document.selection ? (a.focus(), document.selection.createRange().text) : a.selectionStart || "0" == a.selectionStart ? a.value.substring(a.selectionStart, a.selectionEnd) : a.value }
    function sleep(a) { for (var b = (new Date).getTime(); b + a >= (new Date).getTime();); }; CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,basicstyles,blockquote,notification,button,toolbar,clipboard,panel,floatpanel,menu,contextmenu,resize,elementspath,enterkey,entities,popup,filetools,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastetools,pastefromgdocs,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,tableselection,undo,lineutils,widgetselection,widget,notificationaggregator,uploadwidget,uploadimage,wsc,ckwebspeech,Text2Speech'; CKEDITOR.config.skin = 'moono-lisa'; (function () { var setIcons = function (icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(','); for (var i = 0; i < icons.length; i++)CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,image,360,,indent-rtl,384,,indent,408,,outdent-rtl,432,,outdent,456,,anchor-rtl,480,,anchor,504,,link,528,,unlink,552,,bulletedlist-rtl,576,,bulletedlist,600,,numberedlist-rtl,624,,numberedlist,648,,maximize,672,,pastetext-rtl,696,,pastetext,720,,pastefromword-rtl,744,,pastefromword,768,,removeformat,792,,source-rtl,816,,source,840,,specialchar,864,,scayt,888,,table,912,,redo-rtl,936,,redo,960,,undo-rtl,984,,undo,1008,,spellchecker,1032,,speech,2112,auto,webspeech-enable,2160,auto,webspeech-settings,2208,auto,webspeech,2256,auto,icona-audio,2304,auto', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,image,360,auto,indent-rtl,384,auto,indent,408,auto,outdent-rtl,432,auto,outdent,456,auto,anchor-rtl,480,auto,anchor,504,auto,link,528,auto,unlink,552,auto,bulletedlist-rtl,576,auto,bulletedlist,600,auto,numberedlist-rtl,624,auto,numberedlist,648,auto,maximize,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,removeformat,792,auto,source-rtl,816,auto,source,840,auto,specialchar,864,auto,scayt,888,auto,table,912,auto,redo-rtl,936,auto,redo,960,auto,undo-rtl,984,auto,undo,1008,auto,spellchecker,1032,auto,speech,1056,auto,webspeech-enable,1080,auto,webspeech-settings,1104,auto,webspeech,1128,auto,icona-audio,1152,auto', 'icons.png'); })(); CKEDITOR.lang.languages = { "en": 1 };
}());